...
import com.forever.foreveroj.constant.FileConstant;
import com.forever.foreveroj.exception.BusinessException;
import com.forever.foreveroj.manager.CosManager;
import com.forever.foreveroj.model.dto.file.UploadFileRequest;
import com.forever.foreveroj.model.entity.User;
import com.forever.foreveroj.model.enums.FileUploadBizEnum;
 ...
 * 文件接口
 *
 * @author <a href="https://github.com/RicardoLou">RicardoLou</a>a>
 */
@RestController
@RequestMapping("/file")
@Slf4j
